...
# Add the backend directory to the path before importing local modules
backend_dir = os.path.dirname(os.path.abspath(__file__))
sys.path.insert(0, backend_dir)  # noqa: E402

from main import CommandHandler  # noqa: E402
